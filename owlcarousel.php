    ...
    */
    ...
    public static function instance() {
            ...
            if ( ! isset( self::$instance ) ) {
                    self::$instance = new WP_OwlCarousel;
    ...
    function includes(){
        require_once($this->plugin_dir . 'wp-owlc-widgets.php');
    }
    ...
    function widget_init() {
        register_widget("WP_OwlCarousel_Widget");
    }
...
function wp_owlc() {
	return WP_OwlCarousel::instance();
}
