...
A new Owl Carousel menu item will be visible in the admin menu. Create a new category and add as much items as you need (use the featured image to define the item image).


Now, you can add your carousel into any post with the following shortcode (or using the custom TinyMCE button):
